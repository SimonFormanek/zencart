...
$define = [
    'TEXT_ACCEPTED_CREDIT_CARDS' => '<strong>Přijímáme:</strong> ',
    'TEXT_CC_ENABLED_VISA' => 'Visa',
    'TEXT_CC_ENABLED_MC' => 'MasterCard',
    'TEXT_CC_ENABLED_AMEX' => 'American Express',
    'TEXT_CC_ENABLED_DINERS_CLUB' => 'Diners Club',
    'TEXT_CC_ENABLED_DISCOVER' => 'Discover',
    'TEXT_CC_ENABLED_JCB' => 'JCB',
    'TEXT_CC_ENABLED_AUSTRALIAN_BANKCARD' => 'Australská Bankovní karta',
    'TEXT_CC_ENABLED_SOLO' => 'Solo',
    'TEXT_CC_ENABLED_DEBIT' => 'Debetní karta',
